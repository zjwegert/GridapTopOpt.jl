...
using Gridap, GridapDistributed, PartitionedArrays, GridapPETSc
using Gridap.Geometry, Gridap.FESpaces, Gridap.ReferenceFEs, Gridap.CellData, Gridap.Arrays
using FillArrays
...
function ReferenceFEs.get_dof_to_node(a::LagrangianDofBasis)
  return a.dof_to_node
end
function ReferenceFEs.get_dof_to_comp(a::LagrangianDofBasis)
  return a.dof_to_comp
end
...
node_coords = get_dof_coordinates(space)
