...
As a result the partial derivatives of $\mathcal{L}_\Omega$ in $\boldsymbol{v}$ and $\boldsymbol{q}$ are the same as previously up to relaxation of $D$ with $\chi_\epsilon(\varphi)$, i.e.,

$$
\begin{aligned}
0=\frac{\partial\mathcal{L}_\Omega}{\partial\boldsymbol{q}}(\boldsymbol{\phi})&=\int_\Omega\boldsymbol{\phi}\cdot(-\mathrm{div}(\chi_\epsilon(\varphi)\boldsymbol{C\varepsilon}(\boldsymbol{u}))-\chi_\epsilon(\varphi)\boldsymbol{f})\,\mathrm{d}\boldsymbol{x}+\int_{\Gamma_R}\boldsymbol{\phi}\cdot(\chi_\epsilon(\varphi)\boldsymbol{C\varepsilon}(\boldsymbol{v})\boldsymbol{n}+\boldsymbol{w}(\boldsymbol{v}))\,\mathrm{d}s\\
...
$$
\begin{aligned}
0=\frac{\partial\mathcal{L}_\Omega}{\partial\boldsymbol{v}}(\boldsymbol{\phi})&=\int_{\Omega} \boldsymbol{\phi}\cdot(-\mathrm{div}(\chi_\epsilon(\varphi)\boldsymbol{C\varepsilon}(\boldsymbol{q}))-\chi_\epsilon(\varphi)j^\prime(\boldsymbol{v}))\,\mathrm{d}\boldsymbol{x}+\int_{\Gamma_N} \boldsymbol{\phi}\cdot (\chi_\epsilon(\varphi)\boldsymbol{C\varepsilon}(\boldsymbol{q})\boldsymbol{n}+l_1^\prime(\boldsymbol{v}))\,\mathrm{d}s\\
...
This exactly as previously up to relaxation over $D$. Finally, The derivative of $J_\Omega(\varphi)=\mathcal{L}_\Omega(\varphi,\boldsymbol{u},\boldsymbol{\lambda})$ then follows by application of the chainrule as previously:

$$
\begin{aligned}
J_\Omega^\prime(\varphi)(v)&=\frac{\partial\mathcal{L}_\Omega}{\partial\varphi}(\varphi,\boldsymbol{u},\boldsymbol{\lambda})(v)+\cancel{\frac{\partial\mathcal{L}_\Omega}{\partial\boldsymbol{v}}(\varphi,\boldsymbol{u},\boldsymbol{\lambda})}(\boldsymbol{u}^\prime(v))+\cancel{\frac{\partial\mathcal{L}_\Omega}{\partial\boldsymbol{q}}(\varphi,\boldsymbol{u},\boldsymbol{\lambda})}(\boldsymbol{\lambda}^\prime(v))\\
...
$${\huge{|}} J^\prime(\Omega)(v\boldsymbol{n}) - J_{\Omega}^\prime(\varphi)(v){\huge{|}}=O(\epsilon).$$
