...
function main()
  path = "./results/Staggered_FCM_2d_FSI_NavierStokes_P2P1_GMSH/"
  mkpath(path)
  ...
  res_fluid((),(u,p),(v,q),φ) = a_fluid((u,p),(v,q),φ) + c(u,v,φ)
  jac_fluid((),(u,p),(du,dp),(v,q),φ) = a_fluid((du,dp),(v,q),φ) + dc(u,du,v,φ)
