...
reinit1 = StabilisedReinitialiser(V_φ,dΩ,h;stabilisation_method=ArtificialViscosity(1.5h))
reinit2 = StabilisedReinitialiser(V_φ,dΩ,h;stabilisation_method=GridapTopOpt.InteriorPenalty(V_φ,γg=1.0))
